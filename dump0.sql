...
CREATE TABLE public.host (
    ...
    CONSTRAINT ck_host_host_status CHECK ((host_status = ANY (ARRAY[0, 1, 2, 3, 4, 5])))
);
...
CREATE TABLE public.subscriptions (
    ...
    CONSTRAINT ck_subscriptions_status CHECK ((status = ANY (ARRAY[0, 1, 2, 3])))
);
...
SELECT pg_catalog.setval('public.company_invite_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.company_trial_id_seq', 1, false);
