...
public class LoggingAspect {
  ...
  @Before("execution(* me.box.files.FileController.view(..))")
  ...
  @Before("execution(* me.box.files.FileController.edit(..))")
  ...
  @Before("execution(* me.box.files.FileController.remove(..))")
  ...
  @Before("execution(* me.box.files.support.listeners.FileViewRequestDenialListener.handle(..))")
  ...
  @Before("execution(* me.box.files.support.listeners.FileEditRequestDenialListener.handle(..))")
  ...
  @Before("execution(* me.box.files.support.listeners.FileRemoveRequestDenialListener.handle(..))")
